...
// import org.assansocketserver.domain.patient.entity.NoContact;
...
// import org.assansocketserver.domain.patient.repository.HighRiskGroupRepository;
// import org.assansocketserver.domain.patient.repository.NoContactRepository;
...
//     private final HighRiskGroupRepository highRiskGroupRepository;
...
//         highRiskGroupRepository.deleteAll();
...
//                 Sector.builder()
//                         .name("북쪽 복도")
//                         .startX(BigDecimal.valueOf(168.0))
//                         .startY(BigDecimal.valueOf(324.0))
//                         .endX(BigDecimal.valueOf(1302.0))
//                         .endY(BigDecimal.valueOf(404.0))
...
//         // **12. HighRiskGroup 생성 (환자와 RiskGroup 연관)**
//         List<HighRiskGroup> highRiskGroups = List.of(
//                 HighRiskGroup.builder()
//                         .patient(patients.get(0))
...
//                 HighRiskGroup.builder()
//                         .patient(patients.get(1))
//                         .riskGroup(riskGroups.get(3))
//                         .build());
//         highRiskGroupRepository.saveAll(highRiskGroups);
//         log.info("HighRiskGroup 초기화 완료");
