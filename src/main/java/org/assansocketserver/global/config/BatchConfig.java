...
import org.assansocketserver.batch.cdc.service.SensorDataService;
...
public class BatchConfig extends DefaultBatchConfiguration {
    ...
    @Bean
    public Job sensorDataJob(JobRepository jobRepository, @Qualifier("sensorDataStep") Step sensorDataStep) {
    ...
    @Bean
    public Job deleteExpiredSensorDataJob(JobRepository jobRepository,
            @Qualifier("deleteExpiredSensorDataStep") Step deleteExpiredSensorDataStep) {
